...
#include "AfficherEntraineur.h"
#include "Entraineur.h"
#include "ModEntraineur.h"
#include "SuprEntraineur.h"
...
namespace AdamClub {
	...
	/// <summary>
	/// Summary for EntraineurMain
	/// </summary>
	public ref class EntraineurMain : public System::Windows::Forms::Form
	{
	public:
		EntraineurMain(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(EntraineurMain::typeid));
			...
			this->button2->Location = System::Drawing::Point(1099, 0);
			...
			this->button1->Click += gcnew System::EventHandler(this, &EntraineurMain::button1_Click);
			// 
			// btn_search
			// 
			...
			this->btn_search->Click += gcnew System::EventHandler(this, &EntraineurMain::btn_search_Click);
			// 
			// btn_supp
			// 
			...
			this->btn_supp->Click += gcnew System::EventHandler(this, &EntraineurMain::btn_supp_Click);
			// 
			// btn_mod
			// 
			...
			this->btn_mod->Click += gcnew System::EventHandler(this, &EntraineurMain::btn_mod_Click);
			// 
			// btn_add
			// 
			...
			this->btn_add->Click += gcnew System::EventHandler(this, &EntraineurMain::btn_add_Click);
			// 
			// p1
			// 
			...
			this->Name = L"EntraineurMain";
			this->Text = L"EntraineurMain";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &EntraineurMain::EntraineurMain_FormClosing);
...
private: System::Void EntraineurMain_FormClosing(System::Object^ sender, System::Windows::Forms::FormClosingEventArgs^ e) {
	if (p1->Controls->Count > 0)
	{
...
private: System::Void btn_mod_Click(System::Object^ sender, System::EventArgs^ e) {
	ModEntraineur^ f = gcnew ModEntraineur();
	AfficherFenetre(f);
}
private: System::Void btn_add_Click(System::Object^ sender, System::EventArgs^ e) {
	
	AddEntraineur^ f = gcnew AddEntraineur();
	AfficherFenetre(f);
}
private: System::Void btn_supp_Click(System::Object^ sender, System::EventArgs^ e) {
	SuprEntraineur^ f = gcnew SuprEntraineur();
	AfficherFenetre(f);
}
private: System::Void btn_search_Click(System::Object^ sender, System::EventArgs^ e) {
	AfficherEntraineur^ f = gcnew AfficherEntraineur();
	AfficherFenetre(f);
}
};
}
