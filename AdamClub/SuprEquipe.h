...
namespace AdamClub {
	...
	/// <summary>
	/// Summary for SuprEquipe
	/// </summary>
	public ref class SuprEquipe : public System::Windows::Forms::Form
	{
	public:
		SuprEquipe(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lb->Location = System::Drawing::Point(596, 120);
			this->lb->Name = L"lb";
			this->lb->Size = System::Drawing::Size(250, 159);
			this->lb->TabIndex = 60;
			this->lb->SelectedIndexChanged += gcnew System::EventHandler(this, &SuprEquipe::lb_SelectedIndexChanged);
			// 
			// button2
			// 
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 20));
			this->button2->ImeMode = System::Windows::Forms::ImeMode::NoControl;
			this->button2->Location = System::Drawing::Point(1028, 501);
			...
			this->button2->Click += gcnew System::EventHandler(this, &SuprEquipe::button2_Click);
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 20));
			this->button1->ImeMode = System::Windows::Forms::ImeMode::NoControl;
			this->button1->Location = System::Drawing::Point(841, 501);
			...
			this->button1->Click += gcnew System::EventHandler(this, &SuprEquipe::button1_Click);
			// 
			// txt_nom
			// 
			this->txt_nom->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 20));
			this->txt_nom->Location = System::Drawing::Point(596, 297);
			...
			this->txt_nom->TextChanged += gcnew System::EventHandler(this, &SuprEquipe::txt_nom_TextChanged);
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(306, 300);
			this->label2->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(71, 31);
			this->label2->TabIndex = 55;
			this->label2->Text = L"Nom";
			this->label2->Click += gcnew System::EventHandler(this, &SuprEquipe::label2_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(306, 120);
			this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(42, 31);
			this->label1->TabIndex = 56;
			this->label1->Text = L"ID";
			this->label1->Click += gcnew System::EventHandler(this, &SuprEquipe::label1_Click);
			// 
			// SuprEquipe
			// 
			...
			this->Name = L"SuprEquipe";
			this->Text = L"SuprEquipe";
			this->Load += gcnew System::EventHandler(this, &SuprEquipe::SuprEquipe_Load);
...
private: System::Void SuprEquipe_Load(System::Object^ sender, System::EventArgs^ e) {
	afterdelete();
}
};
}
