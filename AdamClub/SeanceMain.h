#pragma once
#include "AddSeance.h"
#include "AfficherSeance.h"
#include "ModSeance.h"
#include "SuprSeance.h"
...
namespace AdamClub {
	...
	/// <summary>
	/// Summary for SeanceMain
	/// </summary>
	public ref class SeanceMain : public System::Windows::Forms::Form
	{
	public:
		SeanceMain(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(SeanceMain::typeid));
			...
			this->p1->TabIndex = 3;
			this->p1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &SeanceMain::p1_Paint);
			// 
			// panel1
			// 
			...
			this->panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &SeanceMain::panel1_Paint);
			// 
			// button4
			// 
			...
			this->button4->Location = System::Drawing::Point(1107, 0);
			...
			this->button1->Click += gcnew System::EventHandler(this, &SeanceMain::button1_Click);
			// 
			// btn_search
			// 
			...
			this->btn_search->Click += gcnew System::EventHandler(this, &SeanceMain::btn_search_Click);
			// 
			// btn_supp
			// 
			...
			this->btn_supp->Click += gcnew System::EventHandler(this, &SeanceMain::btn_supp_Click);
			// 
			// btn_mod
			// 
			...
			this->btn_mod->Click += gcnew System::EventHandler(this, &SeanceMain::btn_mod_Click);
			// 
			// btn_add
			// 
			...
			this->btn_add->Click += gcnew System::EventHandler(this, &SeanceMain::btn_add_Click);
			// 
			// SeanceMain
			// 
			...
			this->Name = L"SeanceMain";
			this->Text = L"SeanceMain";
...
private: System::Void btn_supp_Click(System::Object^ sender, System::EventArgs^ e) {
	SuprSeance^ f = gcnew SuprSeance();
	AfficherFenetre(f);
}
private: System::Void btn_search_Click(System::Object^ sender, System::EventArgs^ e) {
	AfficherSeance^ f = gcnew AfficherSeance();
	AfficherFenetre(f);
}
private: System::Void btn_add_Click(System::Object^ sender, System::EventArgs^ e) {
	AddSeance^ f = gcnew AddSeance();
	AfficherFenetre(f);
}
private: System::Void btn_mod_Click(System::Object^ sender, System::EventArgs^ e) {
	ModSeance^ f = gcnew ModSeance();
	AfficherFenetre(f);
}
