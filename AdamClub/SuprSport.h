...
namespace AdamClub {
	...
	/// <summary>
	/// Summary for SuprSport
	/// </summary>
	public ref class SuprSport : public System::Windows::Forms::Form
	{
	public:
		SuprSport(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lb->TabIndex = 66;
			this->lb->SelectedIndexChanged += gcnew System::EventHandler(this, &SuprSport::lb_SelectedIndexChanged);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &SuprSport::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &SuprSport::button1_Click);
			// 
			// txt_nom
			// 
			...
			this->txt_nom->TabIndex = 63;
			this->txt_nom->TextChanged += gcnew System::EventHandler(this, &SuprSport::txt_nom_TextChanged);
			// 
			// label2
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &SuprSport::label2_Click);
			// 
			// label1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &SuprSport::label1_Click);
			// 
			// SuprSport
			// 
